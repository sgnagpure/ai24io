...
const MyComponent = () => {
    ...
    let tokenData = {
        ...
        "presaleContract": "0x509e2AfCAF74E6Ad87A9bDD1a80a60Ee630Aite969",
        "contractABI": "",
        "tokenIconURL": "/logo.png",
        "tokenName": "AI24 Coin",
        "tokenSymbol": "AI24",
        ...
        "type": "BEP20",
        "presaleRunning": "true",
        "kycVerified": "https://ai24.io/",
        "smartContractAudit": "https://ai24.io/",
    }
        ...
        <>
            <section className={styles.cover}>
                    ...
                    <div className={styles.tokenPresaleContainerInner} id="presale-container">
                        <div className={styles.cardHeader}>
                            <div className={styles.logoBlock}>
                                <img src="/logo.png" alt="token" className={styles.tokenImagePrime} />
                            </div>
                            ...
                            <div className={styles.primeBlock}>
                                ...
                                <a target="_blank" href="https://bscscan.com/token/0x428ddfbdd559800abec23add2d61308dd66804a0" rel="noreferrer">View on Bscscan</a>
                            </div>
                        ...
                        <div className={styles.actionBlockPrime}>
                            ...
                            <a className={styles.buyButton} style={{'textAlign':'center'}} href="/users/dashboard" id='buy-button'>Buy</a>
                        </div>
                        ...
                        <div className={styles.leastDetailBlockPrime}>
                            <a className={styles.leastDetailTagPrime} href="https://bscscan.com/token/0x428ddfbdd559800abec23add2d61308dd66804a0" rel="noreferrer" target="_blank">View Presale Smart Contract Address</a>
                        </div>

                    </div>
                    <div className={styles.brandText}><Link href="https://www.AI24.io"><a target="_blank" rel="noreferrer" id="host">Powered by AI24</a></Link></div>
                ...
                <div className={styles.textSection}>
                    ...
                    <h2 className={styles.header}>AI24 Coin</h2>
                    <h4 className={styles.tag}>
                    AI24 is a powerful blockchain-based platform that allows businesses to access the immense potential of AI and machine learning without the complexity and cost of traditional AI solutions.
                    </h4>
            ...
            <div className={styles.contractNoteSection}>
                <p className={styles.contractNote}>You can buy AI24 also by Pancakeswap</p>
                <p id="contract-address" className={styles.contractAddress}>0x428dDFBdD559800AbEC23AdD2d61308Dd66804A0</p><br/>
